d3.csv("data/prod-conso.csv").then(function(data) {
    ...
    function drawChart() {
        d3.select("#prod-conso").selectAll("*").remove();
    
        // Taille et marges du graphique
        const margin = { top: 20, right: 50, bottom: 50, left: 20 },
              width = document.getElementById('prod-conso').clientWidth - margin.left - margin.right,
